...
USetMeshComponentVertexColorsNode::USetMeshComponentVertexColorsNode() {
	...
	FunctionReference.SetFromField<UFunction>(UVertexPaintTasksFunctionLibrary::StaticClass()->FindFunctionByName(GET_FUNCTION_NAME_CHECKED(UVertexPaintTasksFunctionLibrary, SetMeshComponentVertexColors_Wrapper)), true);
}
