...
void FVertexPaintDetectionPluginModule::StartupModule() {
	...
	UE_LOG(RuntimeVertexColorPlugin, Log, TEXT("Vertex Paint Detection Module Startup!"));
}
...
void FVertexPaintDetectionPluginModule::ShutdownModule() {
	...
	UE_LOG(RuntimeVertexColorPlugin, Log, TEXT("Vertex Paint Detection Module Shutdown!"));
}
