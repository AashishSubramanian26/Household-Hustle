...
void FVertexDetectTaskFinished_DelegateWrapper(const FMulticastScriptDelegate& VertexDetectTaskFinished, FVertexDetectTaskResultInfo const& taskResultInfo, FVertexDetectAdditionalDataToPassThrough const& additionalData)
{
	...
	UVertexPaintDetectionGISubSystem::~UVertexPaintDetectionGISubSystem() {}
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VertexPaintDetectionPlugin_Source_VertexPaintDetectionPlugin_Subsystems_VertexPaintDetectionGISubSystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VertexPaintDetectionPlugin_Source_VertexPaintDetectionPlugin_Subsystems_VertexPaintDetectionGISubSystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VertexPaintDetectionPlugin_Source_VertexPaintDetectionPlugin_Subsystems_VertexPaintDetectionGISubSystem_h_3462483311(TEXT("/Script/VertexPaintDetectionPlugin"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VertexPaintDetectionPlugin_Source_VertexPaintDetectionPlugin_Subsystems_VertexPaintDetectionGISubSystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VertexPaintDetectionPlugin_Source_VertexPaintDetectionPlugin_Subsystems_VertexPaintDetectionGISubSystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
